...
const Login= () => {
  ...
  return (
    <section id="login" className="min-h-screen mt-4 bg-background flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-teal p-8 border border-surface-border">

        <h2 className="text-2xl font-semibold text-text-primary mb-1 text-center ">Log In</h2>
          ...
          <button
            ...
            >
             ...
             <Link to="/signup"
              type="button"
              className="w-full bg-primary text-center hover:bg-primary-dark text-white font-medium py-2.5 rounded-xl shadow-teal transition-colors duration-200 text-sm"
            >
             Sign Up
            </Link>
</div>
